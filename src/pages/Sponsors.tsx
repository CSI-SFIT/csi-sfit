...
export const Sponsors: React.FC = () => {
  ...
  // 🔧 Removed `tier` from props (it was unused)
  const SponsorCard: React.FC<{ sponsor: Sponsor; index: number }> = ({
    ...
    return (
      ...
      >
        <StarBorder
          color={
            sponsor.name === "AECC Study Abroad Consultants"
              ? "#40E0D0"
              : "#FFCDB9"
          }
          speed="3s"
  ...
  const sponsors: Sponsor[] = [
    {
      ...
      tier: "platinum",
      description:
        "Expert Study Abroad Consultants for Top Overseas Destinations.",
    ...
    <div className="min-h-screen bg-dark-800 text-white">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              We're grateful to our amazing sponsors who support our mission to
              empower students with technology education and innovation
              opportunities.
            </motion.p>
          </motion.div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {(["platinum"] as Sponsor["tier"][]).map((tier) => (
            <div key={tier} className="mb-16">
              <h3 className="text-2xl font-bold text-gray-300 mb-8 text-center capitalize">
                {tier} Partners
              </h3>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <GlassCard className="p-8 text-center">
                ...
                <p className="text-gray-400 mb-6">
                  Download our comprehensive sponsorship kit to learn more about
                  partnership opportunities and the impact of your support.
                </p>
                <motion.a
                  href="/brochure.pdf"
                  target="_blank"
