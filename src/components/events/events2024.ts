...
const events2024: EventItem[] = [
  ...
  },
  {
    ...
    locationLink: 'https://www.google.com/maps/search/?api=1&query=SFIT%20Lab%20128',
    category: 'workshop',
    status: 'completed',
  ...
  },
  {
    ...
    speakers: ['Om Kate'],
    speakerLinks: {
      'Om Kate': { github: 'https://github.com/skinatro', linkedin: 'https://www.linkedin.com/in/skinatro' }
    }
  }
];
